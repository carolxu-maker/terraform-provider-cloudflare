...
func TestAccCloudflareR2BucketSippyDataSource_Basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccR2BucketSippyDataSourceConfig(rnd),
...
func testAccR2BucketSippyDataSourceConfig(rnd string) string {
