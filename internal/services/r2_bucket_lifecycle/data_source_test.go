...
func TestAccCloudflareR2BucketLifecycleDataSource_Basic(t *testing.T) {
	...
	name := "cloudflare_r2_bucket_lifecycle." + rnd
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccR2BucketLifecycleDataSourceConfig(rnd),
...
func testAccR2BucketLifecycleDataSourceConfig(rnd string) string {
